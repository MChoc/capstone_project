# Generated by Django 3.0.4 on 2020-04-26 02:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('PERCENTAGE', '%'), ('DOLLAR', 'Dollar')], default='PERCENTAGE', max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Extra',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kitchen_note', models.CharField(blank=True, max_length=1024, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transaction_food_items', to='menu.Transaction')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problems', models.ManyToManyField(to='menu.Problem')),
