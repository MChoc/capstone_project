# Generated by Django 3.0.4 on 2020-03-30 04:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra', models.ManyToManyField(to='menu.Extra')),
        ...
        migrations.AddField(
            model_name='fooditem',
            name='transactions',
            field=models.ManyToManyField(through='menu.TransactionFoodItem', to='menu.Transaction'),
        ),
        migrations.CreateModel(
            name='Drink',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('size', models.CharField(choices=[('LARGE', 'L'), ('MEDIUM', 'M'), ('SMALL', 'S')], default='MEDIUM', max_length=8)),
                ('food_item', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='menu.FoodItem')),
            ],
        ),
        migrations.AddField(
            model_name='category',
